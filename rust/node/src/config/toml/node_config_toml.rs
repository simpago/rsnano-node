...
use super::{
    ActiveElectionsConfigToml, BlockProcessorConfigToml, BootstrapAscendingConfigToml,
    BootstrapServerConfigToml, DiagnosticsConfigToml, IpcConfigToml, LmdbConfigToml,
    MessageProcessorConfigToml, Miliseconds, MonitorConfigToml, OptimisticSchedulerConfigToml,
    PriorityBucketConfigToml, RequestAggregatorConfigToml, StatsConfigToml, VoteCacheConfigToml,
    VoteProcessorConfigToml, WebsocketConfigToml,
};
...
pub struct NodeConfigToml {
    ...
    pub optimistic_scheduler: Option<OptimisticSchedulerConfigToml>,
    pub priority_bucket: Option<PriorityBucketConfigToml>,
    pub bootstrap_ascending: Option<BootstrapAscendingConfigToml>,
    pub bootstrap_server: Option<BootstrapServerConfigToml>,
    ...
    pub block_processor: Option<BlockProcessorConfigToml>,
    pub active_elections: Option<ActiveElectionsConfigToml>,
    pub vote_processor: Option<VoteProcessorConfigToml>,
    pub request_aggregator: Option<RequestAggregatorConfigToml>,
    pub message_processor: Option<MessageProcessorConfigToml>,
    pub monitor: Option<MonitorConfigToml>,
