...
impl Default for IpcConfig {
    fn default() -> Self {
        Self {
            transport_domain: IpcConfigDomainSocket::default(),
            transport_tcp: IpcConfigTcpSocket::default(),
            flatbuffers: IpcConfigFlatbuffers::default(),
        }
    }
}
